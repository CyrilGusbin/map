...
execute store result entity @s power[0] double 0.0025 run scoreboard players operation @s motionX2 -= @s motionX1
execute store result entity @s power[1] double 0.0025 run scoreboard players operation @s motionY2 -= @s motionY1
execute store result entity @s power[2] double 0.0025 run scoreboard players operation @s motionZ2 -= @s motionZ1

data modify entity @s Owner set from entity @e[type=ghast,limit=1,name="Diseased Ghast"] UUID
