...
execute at @s facing entity @e[type=player,limit=1,sort=arbitrary] feet run teleport @s ^ ^ ^0.10
...
execute store result entity @s power[0] double 0.004 run scoreboard players operation @s motionX2 -= @s motionX1
execute store result entity @s power[1] double 0.004 run scoreboard players operation @s motionY2 -= @s motionY1
execute store result entity @s power[2] double 0.004 run scoreboard players operation @s motionZ2 -= @s motionZ1
