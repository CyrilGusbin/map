...
tellraw @a ["",{"text":"["},{"text":"The Dark One","color":"dark_purple","bold":true},{"text":"] Impossible!  How are you this strong!?"}]
execute at @e[type=wither,name="The Dark One"] run playsound minecraft:entity.wither.death ambient @a ~ ~ ~ 5 0.8 1
