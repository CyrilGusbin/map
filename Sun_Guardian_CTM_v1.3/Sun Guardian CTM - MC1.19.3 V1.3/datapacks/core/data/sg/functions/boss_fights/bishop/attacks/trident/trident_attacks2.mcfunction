...
execute if score @s timer matches 120 run function sg:boss_fights/bishop/attacks/trident/throw_trident
execute if score @s timer matches 125 run function sg:boss_fights/bishop/attacks/trident/throw_trident
...
execute if score @s timer matches 220 run function sg:boss_fights/bishop/attacks/trident/throw_trident
execute if score @s timer matches 225 run function sg:boss_fights/bishop/attacks/trident/throw_trident