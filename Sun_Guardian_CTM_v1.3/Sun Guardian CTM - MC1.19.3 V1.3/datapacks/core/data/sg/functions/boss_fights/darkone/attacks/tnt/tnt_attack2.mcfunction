...
execute if score @s timer matches 110 at @e[type=minecraft:armor_stand,name=witherMarker] run summon tnt ~1 ~15 ~22 {Fuse:30,Tags:["darkone"]}
execute if score @s timer matches 120 at @e[type=minecraft:armor_stand,name=witherMarker] run summon tnt ~ ~15 ~3 {Fuse:30,Tags:["darkone"]}
